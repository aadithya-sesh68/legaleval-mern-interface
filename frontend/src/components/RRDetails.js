...
export default function RRDetails({ rrdoc }) {
            ...
            <div className="button-container">
              ...
              <Modal isOpen={showModal} onRequestClose={closeModal}>
                ...
                <table style={{ border: "1px solid" }}>
                  <thead>
                    <tr>
                      <th style={{ border: "1px solid" }}>Sentence</th>
                      <th style={{ border: "1px solid" }}>Rhetorical Role</th>
                    </tr>
                  </thead>
                  <tbody style={{ border: "1px solid" }}>
                    {rrdoc.sent_tags.map((doc) => (
                      <>
                        <tr>
                          <td
